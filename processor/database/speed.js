const data = {
    ...
    nm_hour: {
        ...
        query: ['nm/hour', 'nm/h', 'nmhour', 'nmh', 'нм/ч', 'нм/час', 'нанометров в час', 'нм в час', 'нм в ч', 'нмчас', 'нм час']
    },
    mcm_hour: {
        r: '1000000 / (1 / (60 * 60))',
        query: ['mcm/hour', 'mcm/h', 'mcmhour', 'mcmh', 'мкм/ч', 'мкм/час', 'микрон в час', 'микрометров в час', 'мкм в ч', 'мкм в час', 'мкмчас', 'мкм час']
    },
    mm_hour: {
        r: '1000 / (1 / (60 * 60))',
        query: ['mm/hour', 'mm/h', 'mmhour', 'mmh', 'мм/ч', 'мм/час', 'миллиметров в час', 'мм в час', 'мм в ч', 'ммчас', 'мм час']
    },
    cm_hour: {
        r: '100 / (1 / (60 * 60))',
        query: ['cm/hour', 'cm/h', 'cmhour', 'cmh', 'см/ч', 'см/час', 'сантиметров в час', 'см в час', 'см в ч', 'смчас', 'см час']
    },
    dm_hour: {
        r: '10 / (1 / (60 * 60))',
        query: ['dm/hour', 'dm/h', 'dmhour', 'dmh', 'дм/ч', 'дм/час', 'дециметров в час', 'дм в час', 'дм в ч', 'дмчас', 'дм час']
    },
    m_hour: {
        r: '1 / (1 / (60 * 60))',
        query: ['m/hour', 'm/h', 'mhour', 'mh', 'м/ч', 'м/час', 'метров в час', 'м в час', 'м в ч', 'мчас','м час']
    },
    km_hour: {
        r: '(1 / 1000) / (1 / (60 * 60))',
        query: ['km/hour', 'km/h', 'kmhour', 'kmh', 'км/час', 'км/ч', 'километров в час', 'км в час', 'км в ч', 'кмчас','км час']
    },
    mi_hour: {
        r: '(1 / 1609) / (1 / (60 * 60))',
    ...
    yd_hour: {
        r: '1.094 / (1 / (60 * 60))',
        query: ['yph', 'yphour', 'yd/h', 'yards/h', 'ydh', 'yardsh', 'ярд/час', 'ярд/ч', 'ярд в час', 'ярдов в час', 'ярд в ч', 'ярдов в ч', 'ярдчас', 'ярд час']
    },
    ft_hour: {
        r: '3.281 / (1 / (60 * 60))',
        query: ['fph', 'fphour', 'ft/h', 'feet/h', 'fth', 'feeth', 'фут/час', 'фут/ч', 'фут в час', 'футов в час', 'фут в ч', 'футов в ч', 'футчас', 'фут час']
    },
    in_hour: {
        r: '39.37 / (1 / (60 * 60))',
        query: ['inph', 'inches/h', 'in/h', 'inchesh', 'inh', 'дюйм/ч', 'дюйм/час', 'дюйм в час', 'дюймов в час', 'дюйм в ч', 'дюймов в ч', 'дюймчас', 'дюйм час']
    },
    nm_day: {
